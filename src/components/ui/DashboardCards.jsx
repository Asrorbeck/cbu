  ...
  const services = [
    {
      ...
      description: 'View real-time exchange rates for major currencies and historical data',
      icon: 'TrendingUp',
    ...
    },
    {
      id: 'vacancies',
      title: 'Job Vacancies',
      description: 'Browse available positions and submit applications to join our team',
      icon: 'Briefcase',
    ...
    },
    {
      id: 'news',
      title: 'News & Updates',
      description: 'Stay informed with the latest banking news and policy updates',
      icon: 'Newspaper',
